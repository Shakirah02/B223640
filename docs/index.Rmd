...
**Processing the exam season and non-exam season datasets**
...
The next step summarizes the total quantity of prescriptions paid (paid_quantity) by year and period, and visualizes the data using a bar and line plot. Key features of the plot include:
...
1. Across all drugs, **Semester 2 Finals** consistently show the highest prescription totals compared to other periods.
...
2. While **Semester 1 Finals** also show elevated prescription rates, they tend to be lower than those observed during **Semester 2 Finals**. This difference could reflect:
...
3. The trend of **Semester 2 Finals** having the highest prescription rates is evident across all six drugs, including **Sertraline**, **Citalopram**, and **Venlafaxine**, which exhibit the steepest increases.

4. After 2020, the gap between **Semester 2 Finals** and other periods becomes more pronounced for many drugs, indicating an amplification of stress during the end-of-year period, potentially exacerbated by the **COVID-19 pandemic**.
